...
use src\prototypes\WUP_Singleton;
use src\WUP_Plugin;

class WUP_Admin_Template extends WUP_Singleton
{
	/**
	 * Add options page
	 *
     ...
     * @return bool
     */
	public static function add_section( $section, $class=false )
	{
		$settings = self::getInstance();
		$defaults = [
			'page' => null,
	...
	public static function display_page()
	{
        ...
        $buy = false;
        if( empty( get_option( 'pacsoft_license_key' ) ) ){
            $buy = true;
        }
		...
		//TODO display info if KSS is active
	}
}